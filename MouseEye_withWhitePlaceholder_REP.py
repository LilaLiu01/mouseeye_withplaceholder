...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/seanliu/Documents/AMC_Lab/CC_ME_placeholders/MouseEye_withWhitePlaceholder_REP/MouseEye_withWhitePlaceholder_REP.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    for thisTrialsTesting in trialsTesting:
        ...
        # store data for trialsTesting (TrialHandler)
        trialsTesting.addData('key_respTesting.keys',key_respTesting.keys)
        trialsTesting.addData('key_respTesting.corr', key_respTesting.corr)
        if key_respTesting.keys != None:  # we had a response
            trialsTesting.addData('key_respTesting.rt', key_respTesting.rt)
            trialsTesting.addData('key_respTesting.duration', key_respTesting.duration)

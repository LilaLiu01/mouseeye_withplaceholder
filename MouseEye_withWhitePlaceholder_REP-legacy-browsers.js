...
function InstrStartPageRoutineBegin(snapshot) {
  return async function () {
    ...
    InstrStartPageComponents.forEach( function(thisComponent) {
...
function VirtualChinrestRoutineBegin(snapshot) {
  return async function () {
    ...
    VirtualChinrestComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function InstrRedoRoutineBegin(snapshot) {
  return async function () {
    ...
    InstrRedoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function VirtualChinrestRedoRoutineBegin(snapshot) {
  return async function () {
    ...
    VirtualChinrestRedoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trialsTestingLoopBegin(trialsTestingLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    trialsTesting.forEach(function() {
...
function keyPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    keyPracticeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function keyPracFeedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    keyPracFeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function greenFixationRoutineBegin(snapshot) {
  return async function () {
    ...
    greenFixationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function CheckInstrRoutineBegin(snapshot) {
  return async function () {
    ...
    CheckInstrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function CheckInstr_FBRoutineBegin(snapshot) {
  return async function () {
    ...
    CheckInstr_FBComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruction_MainExpRoutineBegin(snapshot) {
  return async function () {
    ...
    Instruction_MainExpComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function displayTestingPhaseRoutineBegin(snapshot) {
  return async function () {
    ...
    displayTestingPhaseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TakeABreak2RoutineBegin(snapshot) {
  return async function () {
    ...
    TakeABreak2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RecogQuestionRoutineBegin(snapshot) {
  return async function () {
    ...
    RecogQuestionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function DiscloseRoutineBegin(snapshot) {
  return async function () {
    ...
    DiscloseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function InstrRT_2RoutineBegin(snapshot) {
  return async function () {
    ...
    InstrRT_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function fixation_RTRoutineBegin(snapshot) {
  return async function () {
    ...
    fixation_RTComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function displayRTRoutineBegin(snapshot) {
  return async function () {
    ...
    displayRTComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EndOfExperimentRoutineBegin(snapshot) {
  return async function () {
    ...
    EndOfExperimentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
